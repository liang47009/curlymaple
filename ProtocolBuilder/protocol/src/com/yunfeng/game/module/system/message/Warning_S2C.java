...
public class Warning_S2C implements IS2CCommand{
	private final short messageId  = 4;
	private String message ;
	private static Warning_S2C instance  = new Warning_S2C();

	public  Warning_S2C(String message){
		
		this.message = message;
	}
	public static Warning_S2C getInstance(){
		return instance;
	}
	private  Warning_S2C(){
