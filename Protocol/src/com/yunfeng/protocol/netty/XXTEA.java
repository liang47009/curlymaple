...
public class XXTEA {
	 ...
	 * 秘钥
	 */
	private static final int[] KEY = new int[] { 1718515065, 6778469 };

	private XXTEA() {
	}

	public static void main(String[] args) {
		String s = "你好：andot。sadf阿斯顿撒地方";
		byte[] e = encrypt(s.getBytes());
		byte[] d = decrypt(e);
	...
	public static byte[] encrypt(byte[] data) {
		...
		return toByteArray(encrypt(toIntArray(data, true), KEY), false);
	}
